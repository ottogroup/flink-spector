...
import org.apache.flink.core.matcher.FromPartialMatcher;
...
public class SeriesMatcher<T> implements FromListMatcher {
	...
	private org.apache.flink.core.matcher.SeriesMatcher<T> matcher;

	public SeriesMatcher(ListMatcherBuilder<T> builder) {
		matcher = org.apache.flink.core.matcher.SeriesMatcher.createFromBuilder(builder);
	}

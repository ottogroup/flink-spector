...
import org.apache.flink.streaming.test.matcher.ListMatcherBuilder;

import java.util.Arrays;
import java.util.List;

public class SeriesMatcher<T> implements FromListMatcher {

	private org.apache.flink.streaming.test.matcher.SeriesMatcher<T> matcher;

	public SeriesMatcher(ListMatcherBuilder<T> builder) {
		matcher = org.apache.flink.streaming.test.matcher.SeriesMatcher.createFromBuilder(builder);
	}
